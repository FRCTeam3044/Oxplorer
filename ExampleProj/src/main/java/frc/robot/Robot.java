...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        pathfinder = new PathfinderBuilder(Field.CHARGED_UP_2023).setCornerDist(1).setPrecomputeGridX(33)
                .setPrecomputeGridY(16).build();
    ...
    public void robotPeriodic() {
        ...
        if (!Arrays.equals(SmartDashboard.getNumberArray("Start Vertex", lastStart), lastStart)
                || !Arrays.equals(SmartDashboard.getNumberArray("End Vertex", lastEnd), lastEnd)) {
            lastStart = SmartDashboard.getNumberArray("Start Vertex", lastStart);
            lastEnd = SmartDashboard.getNumberArray("End Vertex", lastEnd);
            try {
                Path testPath = pathfinder.generatePath(new Vertex(lastStart[0], lastStart[1]),
                        new Vertex(lastEnd[0], lastEnd[1]));
